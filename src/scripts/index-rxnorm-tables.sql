...
DROP INDEX IF EXISTS IDX_RXNATOMARCHIVE_RXAUI;
CREATE INDEX IDX_RXNATOMARCHIVE_RXAUI ON RXNATOMARCHIVE(RXAUI);

DROP INDEX IF EXISTS IDX_RXNATOMARCHIVE_RXCUI;
CREATE INDEX IDX_RXNATOMARCHIVE_RXCUI ON RXNATOMARCHIVE(RXCUI);

DROP INDEX IF EXISTS IDX_RXNATOMARCHIVE_MERGED_TO;
CREATE INDEX IDX_RXNATOMARCHIVE_MERGED_TO ON RXNATOMARCHIVE(MERGED_TO_RXCUI);
