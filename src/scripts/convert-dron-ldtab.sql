...
('BFO:0000053', 'rdf:type', 'owl:ObjectProperty'),
...
SELECT
    ...
    REPLACE(
        REPLACE(
            REPLACE(
                '{"owl:onProperty":[{"datatype":"_IRI","object":"<http://www.obofoundry.org/ro/ro.owl#has_proper_part>"}],"owl:someValuesFrom":[{"datatype":"_JSON","object":{"owl:intersectionOf":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_IRI","object":"OBI:0000576"}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:onProperty":[{"datatype":"_IRI","object":"BFO:0000053"}],"owl:someValuesFrom":[{"datatype":"_IRI","object":"DRON:00000028"}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:onProperty":[{"datatype":"_IRI","object":"BFO:0000053"}],"owl:someValuesFrom":[{"datatype":"_JSON","object":{"owl:intersectionOf":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_IRI","object":"PATO:0000125"}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:hasValue":[{"datatype":"_IRI","object":"UNIT"}],"owl:onProperty":[{"datatype":"_IRI","object":"IAO:0000039"}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:hasValue":[{"datatype":"xsd:double","object":"STRENGTH"}],"owl:onProperty":[{"datatype":"_IRI","object":"OBI:0001937"}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_IRI","object":"rdf:nil"}]}}]}}]}}],"rdf:type":[{"datatype":"_IRI","object":"owl:Class"}]}}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:onProperty":[{"datatype":"_IRI","object":"BFO:0000071"}],"owl:someValuesFrom":[{"datatype":"_IRI","object":"INGREDIENT"}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_IRI","object":"rdf:nil"}]}}]}}]}}]}}],"rdf:type":[{"datatype":"_IRI","object":"owl:Class"}]}}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}',
                'INGREDIENT',
                ingredient
            ),
            'STRENGTH',
...
SELECT
    ...
    'rdfs:subClassOf' AS predicate,
    REPLACE(
        '{"owl:onProperty":[{"datatype":"_IRI","object":"<http://www.obofoundry.org/ro/ro.owl#has_proper_part>"}],"owl:someValuesFrom":[{"datatype":"_JSON","object":{"owl:intersectionOf":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_IRI","object":"OBI:0000576"}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:onProperty":[{"datatype":"_IRI","object":"BFO:0000053"}],"owl:someValuesFrom":[{"datatype":"_IRI","object":"DRON:00000029"}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_JSON","object":{"rdf:first":[{"datatype":"_JSON","object":{"owl:onProperty":[{"datatype":"_IRI","object":"BFO:0000071"}],"owl:someValuesFrom":[{"datatype":"_IRI","object":"INGREDIENT"}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}}],"rdf:rest":[{"datatype":"_IRI","object":"rdf:nil"}]}}]}}]}}],"rdf:type":[{"datatype":"_IRI","object":"owl:Class"}]}}],"rdf:type":[{"datatype":"_IRI","object":"owl:Restriction"}]}',
        'INGREDIENT',
        ingredient
    ) AS object,
    '_JSON' AS datatype
...
(1, 0, 'graph', 'BFO:0000053', 'rdf:type', 'owl:ObjectProperty', '_IRI', NULL), 
(1, 0, 'graph', 'BFO:0000053', 'rdf:type', 'owl:TransitiveProperty', '_IRI', NULL), 
(1, 0, 'graph', 'BFO:0000053', 'rdfs:label', 'is_bearer_of', 'xsd:string', NULL), 
