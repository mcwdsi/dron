These notes are for the EDITORS of dron
...
Make sure you have an ID range in the [idranges file](dron-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [dron-edit.owl](dron-edit.owl)

** DO NOT EDIT dron.obo OR dron.owl in the top level directory **

[../../dron.owl](../../dron.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/uamsdbmi/dron) for details.
 ...
 * [dron-idranges.owl](dron-idranges.owl)
...
This generates derived files such as dron.owl and dron.obo and places
 ...
 * https://github.com/uamsdbmi/dron/releases
 * https://github.com/uamsdbmi/dron/releases/new
...
what is in the `owl:versionIRI` of the derived dron.owl (`data-version` in
dron.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/dron.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/dron/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/uamsdbmi/dron.svg?branch=master)](https://travis-ci.org/uamsdbmi/dron)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/uamsdbmi](https://travis-ci.org/profile/uamsdbmi)
 2. click the "Sync account" button
 3. Click the tick symbol next to dron
